		...
		if(data.code == "40000") {
			...
			if(freestate == "2") {
				...
				if(!vipstate) {
					...
					setTimeout(function() {
						window.location.href = "/static/pc/src/admin/login/new_login.html?type=1";
					}, 2000);
					...
					$.jBox.tip("该视频需要升级后才能观看!", "error");

					setTimeout(function() {
						window.location.href = "/static/pc/src/admin/upgradeVip/upgradeVip.html"
						//						history.go(-1);
					}, 2000);
